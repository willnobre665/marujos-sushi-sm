...
export function MenuHeader({ mesa }: Props) {
  ...
  return (
    <header
      className="sticky top-0 z-40 flex items-center justify-between px-4 bg-background/90 backdrop-blur-md border-b border-border/40"
    ...
    >
      ...
      >
        <IconChevronLeft />
        <span className="font-sans text-[12px]">Início</span>
      </Link>
